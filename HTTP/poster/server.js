...
const USERS = [
  { id: 1, name: "Eddy Mouity", username: "eg12345", password: "egpassword" },
  { id: 2, name: "Joss Mouity", username: "joss12", password: "jspassword" },
  { id: 3, name: "Grace Mouity", username: "gr12345", password: "grpassword" },
];
...
const POSTS = [
  {
    ...
    body: "This is the postLorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book ",
    userId: 1,
  },
];
